...
<div class="container" id="bagas">
  ...
  <div class="row" >
    <div class="col-sm-4 col-sm-offset-4">
      ...
      <form method="POST" action="<?php echo base_url('akun/ubah_passwordm'); ?>/<?php echo $npm; ?>">
        ...
        <div class="form-group">
          ...
          <input type="password" id="3"  class="form-control" minlength="8"  name="password" required>
        </div>
        <div class="form-group">
          <label>Konfirmasi Password:</label>
          <input type="password" id="4" class="form-control" minlength="8"  >
        </div>
        <div class="form-group">
  ...
  <script type="text/javascript">
        $(function () {
            $("#btnSubmit").click(function () {
                ...
                var pas2 = $("#4").val();
                if (password != pas2) {
                    alert("Data yang dinput tidak boleh sama");
                    return false;
                }
                return true;
