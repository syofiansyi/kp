...
<?php
  ...
  <div class="card-body">            
    ...
    href="<?php echo base_url('nilai/tbsemh'); ?>">
...
?>
 <?php if($uji >= 1 ){ ?>
                     ...
                     <a href="<?php echo base_url('nilai/stgagal_semhas');?>/<?php echo $row->id_bimbing; ?>" class="btn btn-success"><i class="fa fa-check">Nilai Lengkap</i></a>
                       <?php } elseif($uji == 0  && $jumlah >= 55){?>
                   <a href="<?php echo base_url('nilai/stlulus_semhas'); ?>/<?php echo $row->id_bimbing; ?>" class="btn btn-success"><i class="fa fa-check">Nilai Lengkap</i></a>
...
?>
 ...
 <?php $tgl = date('Y-m-d'); if(($tgl < $row->tanggal1 ) && ($row->status == 'proses' )){ ?>
                  ...
                  <?php } elseif($row->dipt== $data){?>
                     <a href="<?php echo base_url('nilai/esemhas_nilai');?>/<?php echo $row->id_nilai; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
