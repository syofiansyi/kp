...
<?php
        ...
        <div class="card-header bg-primary">
           <b>Nilai Sidang Skripsi</b>
        </div>
  <div class="card-body">            
            <div class="table-responsive">
     
            <!--   <a class="btn btn-primary"
    href="<?php echo base_url('nilai/tbsidang'); ?>">
...
?>
 <?php if($uji >= 1 ){ ?>
                     ...
                     <a href="<?php echo base_url('nilai/stgagal_sidang');?>/<?php echo $row->id_bimbing; ?>" class="btn btn-success"><i class="fa fa-check">Nilai Lengkap</i></a>
                       <?php } elseif($uji == 0  && $jumlah >= 55){?>
                   <a href="<?php echo base_url('nilai/stlulus_sidang'); ?>/<?php echo $row->id_bimbing; ?>" class="btn btn-success"><i class="fa fa-check">Nilai Lengkap</i></a>
                  
                        <?php } ?>
                          </td>
                          <td>  <?php   $data = $this->session->userdata('username'); ?>
 <?php $tgl = date('Y-m-d'); if(($tgl < $row->tanggal3 ) && ($row->status == 'proses' )){ ?>
                  ...
                  <?php } elseif($row->dipt== $data){?>
                     <a href="<?php echo base_url('nilai/edsid_nilai');?>/<?php echo $row->id_nilai; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
