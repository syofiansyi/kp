<div class="container" id="bagas">
  ...
  <div class="row" >
      ...
      <form  method="POST" action="<?php echo base_url('nilai/edsid_nilai'); ?>/<?php echo $id_nilai; ?>">
       ...
       <div class="form-group">
                 ...
                 <div class="form-group">
                        ...
                        <input  id="nkpg5" name="simpsar" class="form-control" type="number"  min="1" max="100" class="form-control" value="<?php echo $simpsar; ?>"  onchange="nk5(this.value)"  />
