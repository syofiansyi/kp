    ...
    <div class="col-sm-12 col-sm-offset-12">
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <b>Tambah Berkas Seminar Proposal</b>
        </div>
        <div class="card-body">   
    
     <form action="<?=base_url('berkas/tbsemprop') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                       ...
                       <input  type="text" name="id_syarat" id="id_skripsi" required="" class="form-control"  placeholder="Gunakan NPM untuk mencari ID" list="searchresults" autocomplete="off" />
                       <template id="resultstemplate">
                        <?php foreach ($operator as $row):  ?>
                            <option value="<?php echo $row->id_skripsi; ?>"><?php echo $row->id_skripsi; ?>. <?php echo substr($row->judul,0 , 60);?></option>                            
...
<script type="text/javascript">var search = document.querySelector('#id_skripsi');
     ...
     <form action="<?=base_url('berkas/tbsemprop') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="id_bimbing" class="form-control-label"> Judul :</label>
                         ...
                         <select class="form-control" name="id_syarat" id="id_skripsi" required="">
                        <option value=""></option>
