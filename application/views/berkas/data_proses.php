                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>                    
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('berkas/lihat1'); ?>/<?php echo $row->id_syarat; ?>" class="btn btn-primary"data-toggle="tooltip" data-placement="top" title="hapus">Lihat</i></a></td>
                             <td><a href="<?php echo base_url('berkas/lihat2'); ?>/<?php echo $row->id_syarat; ?>" class="btn btn-primary"data-toggle="tooltip" data-placement="top" title="hapus">Lihat</i></a></td>
                   ...
                   <td><a href="<?php echo base_url('berkas/lihat'); ?>/<?php echo $row->id_syarat; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="hapus">Lihat</i></a></td>
                            <td>
                               ...
                               <a href="<?php echo base_url('berkas/iptsemprop'); ?>/<?php echo $row->id_syarat; ?> <?php echo $row->npm; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a> 
                               
                         <a href="<?php echo base_url('berkas/delete_mahasiswa'); ?>/<?php echo $row->id_syarat; ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="hapus"><i class="fa fa-eraser"></i></a></td>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>                    
                        ...
                        <?php $no = 0; foreach($data_mhs as $row): ?>
                        <tr>
                            <td><?php echo ++$no; ?></td>
                            <td><?php echo $row->npm; ?></td>
                               <td> <?php echo $row->nama_mhs; ?></td>
