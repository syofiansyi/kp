...
<p><b>Semua persyaratan yang ada disatukan berbentuk PDF</b></p>
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>                    
                        ...
                        <?php $no = 0; foreach($ms as $row): ?>
                           <?php if(($row->acc_seminar == 'sidang') || ($row->acc_seminar == 's3')): ?>
                        <tr>
                            <td><?php echo ++$no; ?></td>
                            <td><?php echo $row->npm; ?></td>
                         <td> <?php echo $row->nama_mhs; ?></td>
 ...
 <td>  
 <?php if($row->acc_seminar=='sidang'){ ?>
   <a href="<?php echo base_url('berkas/etbsidang'); ?>/<?php echo $row->id_syarat; ?> " class="btn btn-success"><i class="fa fa-edit"></i></a>
