...
<div class="row" >
  <div class="col-sm-12 col-sm-offset-12">
      ...
      <form method="POST" action="<?php echo base_url('berkas/iptsemhas'); ?>/<?php echo $id_syarat; ?>">
        ...
        <div class="form-group">
          ...
          <input type="hidden"  class="form-control" name="id_semhas" value="<?php echo $id_syarat; ?>" readonly required>
        </div>
        <div class="form-group">
             <?php 
        $this->db->select('*');
 ...
 <div class="col-md-6">
    ...
    <option value=Ruang2>Ruang 2</option>
      ...
      <div class="col-md-6">
         <div class="form-group">
          <label>Tanggal:</label>
       <input type="date"  id="tanggal" class="form-control" name="tanggal1" required>
