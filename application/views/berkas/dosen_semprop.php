  ...
  <div class="col-sm-12 col-sm-offset-12">
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <b>Seminar Proposal</b>
        </div>
        <div class="card-body">  

      <?php extract($operator); ?>
      <form method="POST"  action="<?php echo base_url('berkas/iptsemprop'); ?>/<?php echo $npm; ?>">
        <div class="row" id="row">
         ...
         <input type="hidden" id="1" class="form-control" name="id_semprop"  value="<?php echo $id_skripsi; ?>"   readonly >
        </div>
         ...
         <input type="hidden" id="1" class="form-control" name="id_bimbing"  value="<?php echo $id_skripsi; ?>"   readonly >
        </div>
         <div class="form-group">
           <?php 
        $this->db->select('*');
        $this->db->from('pembimbing');
        $this->db->where('id_bimbing',$id_skripsi);
        ...
        $query = $this->db->get();
           ...
           <input type="hidden" id="pb1" class="form-control"  value="<?php echo $pb1; ?>" readonly required>
            <input type="hidden"  class="form-control" name="dipt"  value="<?php echo $pb2; ?>" readonly required>
        ...
        <div class="form-group">
          <label>Ruang:</label>
    <select name="ruang" type="text"  class="form-control" id="6" autocomplete="off" required>
