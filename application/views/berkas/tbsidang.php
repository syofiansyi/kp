...
<div class="container" id="bagas">
  ...
  <div class="row" >
    <div class="col-sm-12 col-sm-offset-12">
     ...
     <form action="<?=base_url('berkas/tbsidang') ?>" method="post" enctype="multipart/form-data">
                     <div class="row" id="row">
                        <div class="col-md-6">  
                    <div class="form-group">
                        <label for="id_bimbing" class="form-control-label"> Judul :</label>
        
                       <input type="text" name="" id="id_bimbing" required="" class="form-control"  placeholder="Gunakan NPM untuk mencari ID" list="searchresults" autocomplete="off" />
       ...
       <div class="col-md-6">
         <div class="form-group">
          <label>Kartu Bimbingan:</label>
                    <input type="file" disabled  class="form-control"  name="kbskrip" >
       ...
       <div class="col-md-6">
         <div class="form-group">
          <label>Surat Izin Seminar:</label>
                    <input type="file" disabled  class="form-control"  name="sizin" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       <div class="col-md-6">
         <div class="form-group">
          <label>Bukti UKT:</label>
                    <input type="file" disabled  class="form-control"  name="ukt" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       ...
       <div class="col-md-6">
         <div class="form-group">
          <label>Transkrip:</label>
                    <input type="file" disabled  class="form-control"  name="transkrip" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       ...
       <div class="col-md-6">
         <div class="form-group">
          <label>LHS:</label>
          <input type="file" disabled  class="form-control"  name="lhs" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       <div class="col-md-6">
         <div class="form-group">
          <label>KRS:</label>
                    <input type="file" disabled  class="form-control"  name="krs" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       <div class="col-md-6">
         <div class="form-group">
          <label>Ijazah:</label>
                    <input type="file" disabled  class="form-control"  name="ijazah" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       <div class="col-md-6">
         <div class="form-group">
          <label>NIM SMA:</label>
          <input type="file" disabled  class="form-control"  name="nim" >
          <button type="submit" disabled name="btnlogin" class="form-control btn btn-warning"><i class="fa fa-upload">Upload</i>&nbsp; </button>
        </div>
      </div>
       <div class="col-md-6">
  ...
  <script type="text/javascript">    
    $(document).ready(function(){        
        ...
        var id_bimbing=$(this).val();
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('berkas/getsidang')?>",
                dataType : "JSON",
                ...
                success: function(data){
                    $.each(data,function(id_bimbing,npm){
                         ...
                         $('[name="id_syarat"]').val(data.id_bimbing+('b'));
    ...
    <div class="col-sm-12 col-sm-offset-12">
     ...
     <form action="<?=base_url('berkas/tbsidang') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" name="" required="" id="id_bimbing" class="form-control">
