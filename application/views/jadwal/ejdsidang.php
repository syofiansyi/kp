<div class="container" id="bagas">
  ...
  <div class="row" >
    <div class="col-sm-4 col-sm-offset-4">
      ...
      <form method="POST" action="<?php echo base_url('sidang/ejd_sidang'); ?>/<?php echo $id_sidang; ?>">
    ...
    <option value=Ruang2>Ruang 2</option>
                    ...
                    <div class="form-group">
                         <label>Tanggal:</label>
                        <input name="tanggal3" id="tanggal" type="date"class="form-control" value="<?php echo $tanggal3; ?>"  required="Pilih Nip Dosen" />
                    </div>
                    <div class="form-group">
                         <label>Pukul:</label>
