...
PROGRAM STUDI PENDIDIKAN NONFORMAL"; ?></font></b><br/>
 ...
 <table> 
    ...
    <tr><td></td><td>Ruang</td><td><?php echo": $row->ruang"; ?></td></tr>
      <tr><td></td><td>Tanggal</td><td><?php echo": $row->tanggal"; ?></td></tr>
        <tr><td></td><td>Pukul</td><td><?php echo": $row->pukul"; ?></td></tr>
          <tr><td></td><td>Penguji Utama</td><td><?php echo": $row->nama_pg1"; ?></td></tr>
             <tr><td></td><td>Penguji Pendamping</td><td><?php echo": $row->nama_pg2"; ?></td></tr>
            <tr><td></td><td></td></tr>
            <tr><td></td><td></td></tr>
            <tr><td></td><td></td></tr>
            <tr><td></td><td></td></tr>
  ...
  <?php if($this->session->userdata('level') === '2') :  ?>
                  <?php $no = 0; foreach($semhas1 as $row): ?>
    <tr><td><?php echo ++$no; ?></td><td>NPM</td><td><?php echo": $row->npm"; ?></td></tr>
    <tr><td></td><td>Nama</td><td><?php echo": $row->nama_mhs"; ?></td></tr>
  <tr><td></td><td>Judul</td><td><?php echo": $row->judul"; ?></td></tr>
    <tr><td></td><td>Ruang</td><td><?php echo": $row->ruang"; ?></td></tr>
  ...
  <?php if($this->session->userdata('akses') === 'dosen') :  ?>
                  <?php $no = 0; foreach($semhas2 as $row): ?>
    <tr><td><?php echo ++$no; ?></td><td>NPM</td><td><?php echo": $row->npm"; ?></td></tr>
    <tr><td></td><td>Nama</td><td><?php echo": $row->nama_mhs"; ?></td></tr>
  <tr><td></td><td>Judul</td><td><?php echo": $row->judul"; ?></td></tr>
    <tr><td></td><td>Ruang</td><td><?php echo": $row->ruang"; ?></td></tr>
   ...
   <?php endif; ?>
        ...
        <table border=0 cellspacing=0 cellpadding=0 id="ketua">
            <tr height=17 >
                ...
                <td width=270  align=center  bgcolor=#ffffff ><font style=font-size:18pt face="arial narrow" color=#000000>Ketua Prodi,</font></td>
            </tr>
            <br><br><br><br>
            <tr height=17  >
                <td width=430   align=left > <br></td>
                <td width=270  align=center  bgcolor=#ffffff ><b><u><font style=font-size:18pt face="times new roman" color=#000000>Drs. Sofino, M.Pd</font></b></u></td>
            </tr>
            <tr height=17 >
                <td width=430  align=left > <br></td>
                <td width=270  align=center   bgcolor=#ffffff ><font style=font-size:18pt face="times new roman" color=#000000>  NIP.196211121988031001 </font></td>
