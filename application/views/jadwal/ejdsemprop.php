<div class="container" id="bagas">
  ...
  <div class="row" >
    <div class="col-sm-4 col-sm-offset-4">
      ...
      <form method="POST" action="<?php echo base_url('semprop/ejd_semprop'); ?>/<?php echo $id_semprop; ?>">

                 <div class="form-group">
                         <label>Ruang:</label>
                        <input id="pg1" readonly="" name="ruang" type="text"class="form-control" value="<?php echo $ruang; ?>"  required="Pilih Nip Dosen" />
    ...
    <option value=Ruang2>Ruang 2</option>
                    ...
                    <div class="form-group">
                         <label>Tanggal:</label>
                        <input name="tanggal" id="tanggal" type="date"class="form-control" value="<?php echo $tanggal; ?>"  required="Pilih Nip Dosen" />
                    </div>
                    <div class="form-group">
                         <label>Pukul:</label>
                     ...
                     <div class="form-group">
                        ...
                        <input name="id_semprop" type="hidden" class="form-control" value="<?php echo $id_semprop; ?>" readonly="" required="Pilih Nip Dosen" />
                    </div>
