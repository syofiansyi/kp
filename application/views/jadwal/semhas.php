...
?></td>
 <td>
                              ...
                              <a href="<?php echo base_url('semhas/sr_semhas'); ?>/<?php echo  $row->id_semhas; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="selesai"><i class="fa fa-download"></i></a>
                                 ...
                                 <?php $tgl = date('Y-m-d'); ?> 
<?php $tgl = date('Y-m-d'); if(($row->tanggal1>= $tgl) && ($row->status == 'selesai')) { ?>
                     ...
                     <button class="btn btn-warning"><i class="fa fa-check">Proses</i></a></button>
                        ...
                        <?php } ?>
                            ...
                            <td>
                              <a href="<?php echo base_url('semhas/ejd_semhas'); ?>/<?php echo  $row->id_semhas; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a></a>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>                    
                        ...
                        <?php $no = 0; foreach($Jdsemhas1 as $row): ?>
                        <tr>
                            <td><?php echo ++$no; ?></td>
                            <td><?php echo $row->nama_mhs; ?></td>
                             <td><?php echo $row->npm; ?></td>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>                    
                        ...
                        <?php $no = 0; foreach($Jdsemhas2 as $row): ?>
                        <tr>
                            <td><?php echo ++$no; ?></td>
                            <td><?php echo $row->nama_mhs; ?></td>
                             <td><?php echo $row->npm; ?></td>
