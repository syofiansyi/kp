...
PROGRAM STUDI PENDIDIKAN NONFORMAL"; ?></font></b><br/>
         ...
         <table  cellpadding="3">
            <tr>
             ...
             <td>: -</td>
             <tr><td>Hal</td>
              <td>: Undangan Ujian Sidang Skripsi</td></tr>
            </tr>
          </table>
          <br><br>
          <table>
   ...
   <p style="text-align: justify; text-indent: 0.5in;">Sehubungan dengan akan diadakannya  ujian skripsi mahasiswa program studi S1 Pendidikan Nonformal FKIP Universitas Bengkulu, dengan ini diharapkan kehadirannya pada :
 </p><br><br>

 <?php $day = date('D', strtotime($tanggal3));
$hari = date('j', strtotime($tanggal3));
$bulan = date('M', strtotime($tanggal3));
$tahun = date('Y', strtotime($tanggal3));
 ...
 <td><?php echo": $npm"; ?></td></tr>
  ...
  <tr><td>Pukul</td>
    ...
    <tr><td>Tempat</td>
      ...
      <tr><td>Acara</td><td> <?php echo": Ujian Sidang Skripsi"; ?></td></tr>
 </tr></table>
