...
PROGRAM STUDI PENDIDIKAN NONFORMAL"; ?></font></b><br/>
         ...
         <table  cellpadding="3">
            <tr>
             ...
             <td>: -</td>
             <tr><td>Hal</td>
              <td>: Undangan Seminar Proposal</td></tr>
            </tr>
          </table>
          <br><br>
          <table>
   ...
   <p style="text-align: justify; text-indent: 0.5in;">Sehubungan dengan akan diadakannya  Seminar Proposal mahasiswa program studi S1 Pendidikan Nonformal FKIP Universitas Bengkulu, dengan ini diharapkan kehadirannya pada :
 </p><br><br>
<?php $day = date('D', strtotime($tanggal));
 ...
 <td><?php echo": $npm"; ?></td></tr>
  ...
  <tr><td>Pukul</td>
    ...
    <tr><td>Tempat</td>
      ...
      <tr><td>Acara</td><td> <?php echo": Ujian Seminar Proposal"; ?></td></tr>
 </tr></table>
